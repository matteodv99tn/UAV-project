...
#include <maple_codegen/force_contact3_params.hpp>
...
Vector force_contact3(VectorRef x) {
  ...
  const float_t tmp__1 =
      t47 * (pos__x__contact * t27 - pos__y__contact * t29 + vx__body) * t25 *
      gamma__4;
  const float_t tmp__2 =
      -t47 * gamma__4 * t25 *
      (pos__y__contact * t27 + pos__x__contact * t29 - vy__body);
