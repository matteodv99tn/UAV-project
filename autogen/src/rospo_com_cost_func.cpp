...
Vector rospo_com_cost_func(VectorRef x, VectorRef u) {
  ...
  const float_t t37 = dF__4 * t36;
  const float_t t39 = t27 * F__1;
  const float_t t40 = t30 * F__2;
  const float_t t41 = t33 * F__3;
  const float_t t42 = t36 * F__4;
  const float_t t44 =
  ...
  const float_t t51 = dt_controller * pos__x__turr;
  const float_t t66 =
      t51 * dF__1 * t27 + t51 * dF__2 * t30 - t51 * dF__3 * t33 - t45 * t14 +
      t45 * t19 - pos__y__turr * t21 + pos__y__turr * t22 - pos__y__turr * t23 +
      pos__y__turr * t24 - t51 * t37 + pos__x__turr * t39 - t45 * t4 +
...
Matrix rospo_com_cost_func_dx(VectorRef x, VectorRef u) {
  ...
  const float_t t2 = dF__1 * dt_controller + F__1;
  const float_t t3 = pos__y__turr * pos__y__turr;
  const float_t t4 = t3 + 0.1e1 / 0.20e2;
  ...
  const float_t t27 = dF__3 * dt_controller + F__3;
  const float_t t28 = t4 * t27;
  const float_t t30 = dt_controller * dphi__3 + phi__3;
  const float_t t31 = cos(t30);
  const float_t t32 = t31 * t28;
  const float_t t35 = dt_controller * dF__4 + F__4;
  ...
  const float_t tmp__1_1 =
      ...
      40 * (t62 + t64 - t66 + t68 + t70 - t73 - t75 - t76 - t77) * t13;
  const float_t t85 =
  ...
  const float_t tmp__1_2 =
      ...
      t2;
  const float_t t94 = t4 * t18;
  const float_t t95 = t23 * t23;
  const float_t t100 = t8 * t19 * t2;
  const float_t t101 = 40 * t100;
  const float_t t103 = t31 * t19 * t27;
  const float_t t104 = 40 * t103;
  const float_t t105 = t4 * t35;
  const float_t t106 = t39 * t105;
  const float_t t108 = 40 * t15;
  const float_t t112 = t8 * t2 * t12;
  ...
  const float_t tmp__1_4 =
      ...
      (t95 * t18 * t12 +
       ...
       t42 * (t44 - t100 - t103 + t106 + t15 - t48 - t52 - t54 - t89)) *
      t18;
  const float_t t125 = t31 * t31;
  const float_t t129 = t8 * t5;
  const float_t t134 = t46 * t27 * t60;
  const float_t t136 = t13 * t71 * t2;
  const float_t t138 = t42 * t71 * t18;
  const float_t t140 = t50 * t35 * t60;
  ...
  const float_t tmp__1_6 =
      ...
      (-t125 * t27 * t12 +
       ...
       (-t48 - t129 + t24 + t40 + t15 + t44 - t52 + t89 - t54) * t46);
  ...
  const float_t tmp__1_11 =
      -40 * t13 * t2 * pos__x__turr - 40 * t23 * t18 * pos__y__turr -
      40 * t42 * t18 * pos__x__turr + 40 * t8 * t2 * pos__y__turr +
      40 * t31 * t27 * pos__y__turr + 40 * t46 * t27 * pos__x__turr -
      40 * t39 * t35 * pos__y__turr + 40 * t50 * t35 * pos__x__turr +
      40 * Tz__ref;
...
Matrix rospo_com_cost_func_du(VectorRef x, VectorRef u) {
  ...
  const float_t t17 = 0.1000000000e1 * t6 + 0.1000000000e1 * t5;
  const float_t t18 = sin(t10);
  const float_t t20 = t18 * t17 * t14;
  const float_t t22 = 0.2e1 - t2;
  const float_t t23 = dF__2 * t4;
  const float_t t24 = dt_controller * F__2;
  ...
  const float_t t31 = dF__3 * t4;
  const float_t t32 = dt_controller * F__3;
  const float_t t33 = t31 + t32;
  const float_t t34 = t33 * t3;
  const float_t t36 = dt_controller * dphi__3 + phi__3;
  const float_t t37 = cos(t36);
  const float_t t39 = dF__4 * t4;
  const float_t t40 = dt_controller * F__4;
  ...
  const float_t t56 = 0.1000000000e1 * t31 + 0.1000000000e1 * t32;
  const float_t t57 = sin(t36);
  const float_t t59 = t57 * t56 * t14;
  const float_t t60 = 0.40e2 * t59;
  const float_t t63 = 0.1000000000e1 * t39 + 0.1000000000e1 * t40;
  ...
  const float_t t112 = dF__3 * dt_controller + F__3;
  const float_t t113 = t37 * t112;
  const float_t t115 = dt_controller * dF__4 + F__4;
  const float_t t118 = t11 * t106 + t29 * t109 + t45 * t115 - Fx__ref + t113;
  const float_t t123 = t50 * t109;
  const float_t t127 = t18 * t106 + t57 * t112 + t64 * t115 - Fy__ref + t123;
  const float_t t147 = -t11 * t106 * pos__y__turr + t18 * t106 * pos__x__turr +
                       ...
                       Tz__ref;
  const float_t tmp__1_2 = -2 * t18 * t118 * t106 * dt_controller +
                           2 * t127 * t106 * dt_controller * t11 +
                           40 * dt_controller *
                               (t11 * pos__x__turr + t18 * pos__y__turr) *
                               t106 * t147 +
                           0.2e0 * dphi__1;
  const float_t t156 = t25 * t3;
  const float_t t157 = t29 * t29;
  const float_t t161 = t11 * t7 * t22;
  const float_t t163 = t37 * t33 * t22;
  const float_t t164 = t41 * t3;
  const float_t t166 = 0.40e2 * t20;
  const float_t t168 = dt_controller * (-t70 - t69);
  const float_t t171 = t50 * t50;
  const float_t t175 = 0.40e2 * t11 * t17 * t14;
  const float_t tmp__1_3 =
      t157 * t156 +
      t29 *
          (0.80e2 * t52 + t161 + t163 + t45 * t164 + t166 - t60 - t67 + t168) +
      t171 * t90 + t50 * (t18 * t78 + t101 - t175 - t86 + t89 + t94 + t96) +
      0.2e0 * dF__2;
  const float_t tmp__1_4 = -2 * t123 * t118 * dt_controller +
                           2 * t109 * t127 * dt_controller * t29 +
                           40 * dt_controller * t109 * t147 *
                               (t29 * pos__x__turr - t50 * pos__y__turr) +
                           0.2e0 * dphi__2;
  const float_t t195 = t37 * t37;
  const float_t t201 = t33 * t77;
  const float_t t202 = t57 * t57;
  const float_t t205 = t18 * t7 * t92;
  const float_t t207 = t50 * t25 * t92;
  const float_t t208 = t41 * t77;
  const float_t t211 = dt_controller * (-t99 + t98);
  const float_t tmp__1_5 =
      t195 * t34 +
      t37 * (0.80e2 * t59 + t11 * t8 + t30 + t46 - t166 - t53 + t67 + t72) +
      t202 * t201 + t57 * (t64 * t208 + t175 + t205 + t207 + t211 - t83 - t89) +
      0.2e0 * dF__3;
  const float_t tmp__1_6 = -2 * t57 * t118 * dt_controller * t112 +
                           2 * t127 * dt_controller * t113 -
                           40 * (t37 * pos__x__turr - t57 * pos__y__turr) *
                               dt_controller * t112 * t147 +
                           0.2e0 * dphi__3;
  const float_t t230 = t45 * t45;
  const float_t t236 = t64 * t64;
  const float_t tmp__1_7 =
      t230 * t164 +
      t45 *
          (-0.80e2 * t66 + t161 + t29 * t156 + t163 + t166 + t53 - t60 + t168) +
      t236 * t208 + t64 * (t57 * t201 + t175 + t205 + t207 + t211 - t83 + t86) +
      0.2e0 * dF__4;
  const float_t tmp__1_8 = -2 * t64 * t118 * t115 * dt_controller +
                           2 * t115 * t127 * dt_controller * t45 -
                           40 * dt_controller *
                               (t45 * pos__x__turr + t64 * pos__y__turr) *
                               t147 * t115 +
                           0.2e0 * dphi__4;
